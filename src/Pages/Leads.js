...
const Leads = () => {
    ...
    //                 branch: filters.branch, phone: filters.phone,
    //             },
    //             headers: {
    //                 Authorization: `Bearer ${token}`,
    //             },
    ...
    useEffect(() => {
        debouncedSearch();
    }, [selectedUsers, selectedLeadType, selectedSource, selectedClient, createdAtStart, createdAtEnd]);
    // selectedPipeline, selectedProduct, selectedBranch,
    return (
        <>
            <Navbar />
            <Container fluid>
                <Row>
                    ...
                    <Col xs={12} md={12} lg={11}>
                        {/* <LeadSearch onSearch={handleSearch} fetchLeadsData={fetchLeadsData} phone={phone} setPhone={setPhone} /> */}
                        <Row>
                            {/* <Col md={3}>
                                <div>
                        ...
                        <Row>
                            ...
                            <Col md={1}>
                                <div style={{ marginTop: '28px' }} className='clear_filter_btn'>
