...
const Leads = () => {
    ...
    console.log(pipelineUsers, 'allUsersallUsers')
    ...
    const fetchLeadsData = async () => {
        ...
        try {
            ...
            // Iterate through each lead and set message counts and selected users
            data.leads.forEach(lead => {
                ...
                const selectedUsers = Array.isArray(lead.selected_users) ? lead.selected_users.map(user => ({
                    id: user._id,
                    name: user.name,
                })) : [];

                selectedUsersMap[lead._id] = selectedUsers;
            });

            console.log(selectedUsersMap, 'selectedUsers')

            // Set message counts and selected users in state
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div className="image_container">
                                                                                            {lead.selected_users
                                                                                                .filter((leadImage) => {
                                                                                                    const excludedRoles = [
                                                                                                        'Developer', 'Marketing', 'CEO', 'CEO/ MD',
                                                                                                        'Super Admin', 'HOD', 'company'
                                                                                                    ];

                                                                                                    return !excludedRoles.includes(leadImage?.role);
                                                                                                })
                                                                                                .map((leadImage, index) => {
                                                                                                    console.log(leadImage, 'leadImageleadImage')
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Select
                                    ...
                                    onChange={(options) => {
                                        ...
                                        setSelectedLeadUsers(options); // Update selected users for this lead
                                        setError('');
                                    }}
