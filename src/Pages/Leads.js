...
const Leads = () => {
    ...
    useEffect(() => {
        console.log('Selected Product Name:', sleectedProductName);
        ...
        if (sleectedProductName === 'Mortgage Loan') {
            setFilterOptions([
                { value: 'CEO Mortgage', label: 'CEO Mortgage' },
    ...
    useEffect(() => {
        if (selectedFilters.length > 0) {
            ...
            setFilteredLeads(leadData);  // Show all leads if no filters are selected
        }
    ...
    useEffect(() => {
        if (leadData && filterOptions) {
            ...
            console.log(pipelineNames, newFilteredOptions, 'pipelineNames')
    ...
    const handleProductClick = (productId, productName) => {
        console.log(productName, 'productName', productId);
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }} className='mb-2'>
                                                                                            <div className='marketing_source_lead' >
                                                                                                ...
                                                                                                <p className='mb-0 text-center' style={{ fontSize: '11px' }}> {lead.pipeline_id?.name && lead.pipeline_id?.name} </p>
                                                                                            </div>
