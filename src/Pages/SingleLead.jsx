...
import { Container, Row, Col, Card, Button, Image, Modal, ProgressBar, OverlayTrigger, Tooltip } from 'react-bootstrap';
                                        ...
                                        labels?.length > 0 && (
                                            <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap' }}>
                                                {labels.map((label, index) => {
                                                    ...
                                                    return (
                                                        <div key={index} style={{ marginRight: '4px', marginTop: '-16px', marginBottom: '14px' }}>
                                                            <div
