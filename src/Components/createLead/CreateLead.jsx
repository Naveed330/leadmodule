...
const CreateLead = ({ setModal2Open, modal2Open, fetchLeadsData }) => {
    ...
    console.log(branch, 'apiDataapiData')
    // Auth Token
    ...
    const handleTransferChange = (e) => {
        ...
        // If the selected product is the same as the previous product
        if (value === '') {
            // If no product is selected, disable fields
            setProductEnableTransfer(true);
        } else if (previousProducts.includes(value)) {
            // If it was previously selected, disable fields
            setProductEnableTransfer(true);
        } else {
            // If it's a new product, enable fields
            setProductEnableTransfer(false);
        }

        // Update the previous products state
        setPreviousProducts((prev) => [...prev, value]);
    }
        ...
        <>
            ...
            >
                    ...
                    {apiData && apiData ? (
                        <>
                            ...
                            <ul>
                                ...
                                <li>Branch: <strong>{apiData && apiData.branch.name}</strong></li>
                ...
                <Modal.Footer>
                    ...
                    <Button className='all_single_leads_button' onClick={() => MoveLead()} >Move Request </Button>
                    <Button className='all_single_leads_button' onClick={() => TransferCase()} >Transfer Request </Button>
                </Modal.Footer>
            </Modal>
