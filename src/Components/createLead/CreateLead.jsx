...
const CreateLead = ({ setModal2Open, modal2Open, fetchLeadsData }) => {
    ...
    console.log(userPipeline, 'userPipeline')
    ...
    // console.log(leadData && leadData.pipeline._id, 'leadData')
    ...
    const fetchProductStages = async () => {
        ...
        console.log(userPipeline, 'selectedPipelineId', pipelineId)
        try {
    ...
    const checkClientPhone = async (completePhoneNumber) => {
        try {
            ...
            if (responseData && responseData.client.phone === completePhoneNumber) {
                ...
                setEid(responseData.client.eid);
    ...
    const handlePipelineInputChange = (e) => {
        ...
        if (product && apiData) {
            ...
            if (matchingProduct && apiData.products.pipeline_id) {
